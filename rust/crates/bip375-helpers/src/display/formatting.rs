...
pub fn key_type_name(category: FieldCategory, key_type: u64) -> &'static str {
    match category {
        ...
        FieldCategory::Input => match key_type {
            ...
            0x21 => "PSBT_IN_MUSIG2_PARTIAL_ECDH_SHARE", // proposed BIP-psbt ext
            0x22 => "PSBT_IN_MUSIG2_PARTIAL_DLEQ",       // proposed BIP-psbt ext
            _ => "PSBT_IN_UNKNOWN",
        },
...
pub fn format_field_name(category: FieldCategory, key_type: u64) -> &'static str {
