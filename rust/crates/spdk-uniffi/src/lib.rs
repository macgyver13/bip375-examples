...
pub use crypto::{
    ...
    bip352_compute_shared_secret_tweak, bip352_derive_silent_payment_output_pubkey,
    bip352_pubkey_to_p2wpkh_script, bip352_tweaked_key_to_p2tr_script, dleq_generate_proof,
    dleq_verify_proof, signing_sign_p2wpkh_input,
};
